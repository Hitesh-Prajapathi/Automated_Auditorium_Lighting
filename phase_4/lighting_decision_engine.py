...
class SimpleRetriever:
    ...
    DEFAULT_PALETTES = {
        # === 7 CORE EMOTIONS ===
        "joy": {
            "primary_colors": [{"name": "warm_amber", "rgb": [255, 191, 0]}, {"name": "golden_yellow", "rgb": [255, 223, 0]}, {"name": "soft_peach", "rgb": [255, 218, 185]}],
            "intensity": {"default": 85},
            "transition": {"type": "fade", "duration": 2.0},
            "color_temperature": "warm"
        },
        "sadness": {
            "primary_colors": [{"name": "steel_blue", "rgb": [70, 130, 180]}, {"name": "midnight_blue", "rgb": [25, 25, 112]}, {"name": "lavender", "rgb": [150, 123, 182]}],
            "intensity": {"default": 40},
            "transition": {"type": "fade", "duration": 4.0},
            "color_temperature": "cool"
        },
        "fear": {
            "primary_colors": [{"name": "dark_red", "rgb": [139, 0, 0]}, {"name": "deep_violet", "rgb": [75, 0, 130]}, {"name": "shadow_blue", "rgb": [30, 30, 80]}],
        ...
        "anger": {
            "primary_colors": [{"name": "deep_red", "rgb": [200, 0, 0]}, {"name": "crimson", "rgb": [220, 20, 60]}, {"name": "blood_orange", "rgb": [204, 85, 0]}],
            "intensity": {"default": 90},
            "transition": {"type": "snap", "duration": 0.5},
            "color_temperature": "warm"
        },
        "neutral": {
            "primary_colors": [{"name": "warm_white", "rgb": [255, 244, 229]}, {"name": "soft_amber", "rgb": [255, 225, 180]}, {"name": "pale_blue", "rgb": [200, 210, 230]}],
            "intensity": {"default": 60},
            "transition": {"type": "fade", "duration": 2.0},
            "color_temperature": "neutral"
        },
        "surprise": {
            "primary_colors": [{"name": "electric_cyan", "rgb": [0, 255, 255]}, {"name": "bright_magenta", "rgb": [255, 0, 144]}, {"name": "flash_white", "rgb": [255, 255, 240]}],
        ...
        "disgust": {
            "primary_colors": [{"name": "sickly_green", "rgb": [173, 255, 47]}, {"name": "yellow_green", "rgb": [154, 205, 50]}, {"name": "bile_yellow", "rgb": [200, 200, 0]}],
            "intensity": {"default": 35},
            "transition": {"type": "smooth", "duration": 3.0},
            "color_temperature": "cool"
        },
        # === EXTENDED THEATRICAL EMOTIONS ===
        "tension": {
            "primary_colors": [{"name": "burnt_orange", "rgb": [204, 85, 0]}, {"name": "dark_amber", "rgb": [180, 100, 20]}, {"name": "blood_red", "rgb": [136, 8, 8]}],
            "intensity": {"default": 55},
            "transition": {"type": "smooth", "duration": 3.0},
            "color_temperature": "warm"
        },
        "nostalgia": {
            "primary_colors": [{"name": "sepia", "rgb": [194, 154, 108]}, {"name": "dusty_rose", "rgb": [194, 125, 130]}, {"name": "antique_gold", "rgb": [205, 175, 100]}],
            "intensity": {"default": 50},
            "transition": {"type": "fade", "duration": 5.0},
            "color_temperature": "warm"
        },
        "romantic": {
            "primary_colors": [{"name": "rose_pink", "rgb": [255, 105, 180]}, {"name": "soft_magenta", "rgb": [200, 100, 150]}, {"name": "warm_lavender", "rgb": [180, 130, 180]}],
            "intensity": {"default": 55},
            "transition": {"type": "fade", "duration": 3.5},
            "color_temperature": "warm"
        },
        "hope": {
            "primary_colors": [{"name": "sunrise_gold", "rgb": [255, 200, 50]}, {"name": "sky_blue", "rgb": [135, 206, 235]}, {"name": "pale_amber", "rgb": [255, 220, 140]}],
            "intensity": {"default": 70},
            "transition": {"type": "fade", "duration": 3.0},
            "color_temperature": "warm"
        },
        "triumph": {
            "primary_colors": [{"name": "royal_gold", "rgb": [255, 215, 0]}, {"name": "regal_purple", "rgb": [128, 0, 128]}, {"name": "bright_amber", "rgb": [255, 191, 0]}],
            "intensity": {"default": 95},
            "transition": {"type": "fade", "duration": 1.5},
            "color_temperature": "warm"
        },
        "despair": {
            "primary_colors": [{"name": "deep_indigo", "rgb": [30, 0, 60]}, {"name": "bruise_purple", "rgb": [60, 20, 80]}, {"name": "cold_grey", "rgb": [80, 80, 100]}],
            "intensity": {"default": 20},
            "transition": {"type": "fade", "duration": 6.0},
            "color_temperature": "cool"
        },
        "serenity": {
            "primary_colors": [{"name": "moonlight_blue", "rgb": [173, 216, 230]}, {"name": "soft_cyan", "rgb": [175, 238, 238]}, {"name": "pale_lavender", "rgb": [200, 190, 220]}],
            "intensity": {"default": 45},
            "transition": {"type": "smooth", "duration": 5.0},
            "color_temperature": "cool"
        },
        "mystery": {
            "primary_colors": [{"name": "deep_purple", "rgb": [72, 0, 120]}, {"name": "midnight_teal", "rgb": [0, 80, 80]}, {"name": "smoky_blue", "rgb": [60, 60, 120]}],
            "intensity": {"default": 30},
            "transition": {"type": "smooth", "duration": 4.0},
            "color_temperature": "cool"
        },
        "anxiety": {
            "primary_colors": [{"name": "sickly_amber", "rgb": [200, 150, 0]}, {"name": "nervous_green", "rgb": [130, 180, 50]}, {"name": "pale_yellow", "rgb": [240, 230, 140]}],
            "intensity": {"default": 50},
            "transition": {"type": "flicker", "duration": 1.5},
            "effects": ["flicker"],
            "color_temperature": "warm"
        },
        "awe": {
            "primary_colors": [{"name": "celestial_blue", "rgb": [100, 149, 237]}, {"name": "violet_haze", "rgb": [138, 43, 226]}, {"name": "starlight_white", "rgb": [240, 248, 255]}],
            "intensity": {"default": 75},
            "transition": {"type": "fade", "duration": 3.0},
            "color_temperature": "cool"
        },
        "jealousy": {
            "primary_colors": [{"name": "envy_green", "rgb": [0, 128, 0]}, {"name": "toxic_yellow", "rgb": [200, 200, 0]}, {"name": "dark_olive", "rgb": [85, 107, 47]}],
            "intensity": {"default": 55},
            "transition": {"type": "smooth", "duration": 2.5},
            "color_temperature": "cool"
        },
        "betrayal": {
            "primary_colors": [{"name": "cold_steel", "rgb": [100, 100, 120]}, {"name": "dark_crimson", "rgb": [130, 0, 30]}, {"name": "ash_grey", "rgb": [140, 140, 140]}],
            "intensity": {"default": 45},
            "transition": {"type": "snap", "duration": 0.8},
            "color_temperature": "cool"
        },
        "confusion": {
            "primary_colors": [{"name": "hazy_purple", "rgb": [150, 100, 180]}, {"name": "murky_teal", "rgb": [80, 140, 130]}, {"name": "dusty_orange", "rgb": [200, 140, 80]}],
            "intensity": {"default": 45},
            "transition": {"type": "pulse", "duration": 2.0},
            "color_temperature": "neutral"
        },
        "amusement": {
            "primary_colors": [{"name": "playful_orange", "rgb": [255, 165, 0]}, {"name": "bubblegum_pink", "rgb": [255, 105, 180]}, {"name": "lime_green", "rgb": [50, 205, 50]}],
            "intensity": {"default": 80},
            "transition": {"type": "fade", "duration": 1.5},
            "color_temperature": "warm"
        },
        "excitement": {
            "primary_colors": [{"name": "electric_orange", "rgb": [255, 100, 0]}, {"name": "hot_magenta", "rgb": [255, 0, 144]}, {"name": "laser_green", "rgb": [0, 255, 65]}],
            "intensity": {"default": 90},
            "transition": {"type": "snap", "duration": 0.5},
            "color_temperature": "warm"
        },
        "chaotic_energy": {
            "primary_colors": [{"name": "neon_pink", "rgb": [255, 16, 240]}, {"name": "electric_blue", "rgb": [0, 130, 255]}, {"name": "acid_green", "rgb": [0, 255, 0]}],
            "intensity": {"default": 85},
            "transition": {"type": "strobe", "duration": 0.3},
            "effects": ["strobe"],
            "color_temperature": "cool"
        },
        "comedic_energy": {
            "primary_colors": [{"name": "warm_orange", "rgb": [255, 180, 50]}, {"name": "candy_pink", "rgb": [255, 130, 171]}, {"name": "sunny_yellow", "rgb": [255, 233, 100]}],
            "intensity": {"default": 80},
            "transition": {"type": "fade", "duration": 1.5},
            "color_temperature": "warm"
        },
        "anticipation": {
            "primary_colors": [{"name": "amber_glow", "rgb": [255, 170, 50]}, {"name": "teal", "rgb": [0, 128, 128]}, {"name": "gold", "rgb": [255, 215, 0]}],
    ...
    # Semantic mapping: emotion synonyms → canonical palette keys
    EMOTION_SYNONYMS = {
        # Joy family
        "happiness": "joy", "happy": "joy", "elation": "joy", "delight": "joy",
        "cheerful": "joy", "bliss": "joy", "euphoria": "excitement",
        # Sadness family  
        "sorrow": "sadness", "grief": "sadness", "melancholy": "sadness",
        "mourning": "sadness", "heartbreak": "sadness", "loneliness": "despair",
        "longing": "nostalgia", "wistful": "nostalgia", "regret": "sadness",
        # Fear family
        "terror": "fear", "dread": "fear", "horror": "fear", "panic": "fear",
        "unease": "anxiety", "worry": "anxiety", "nervous": "anxiety",
        "suspense": "tension", "foreboding": "tension",
        # Anger family
        ...
        "affection": "romantic", "tender": "romantic", "tenderness": "romantic",
        "wonder": "awe", "amazement": "awe", "astonishment": "surprise",
        "gratitude": "hope", "relief": "serenity", "peace": "serenity",
        "calm": "serenity", "tranquil": "serenity", "contentment": "serenity",
        "courage": "triumph", "victory": "triumph", "pride": "triumph",
        "determination": "hope", "optimism": "hope", "aspiration": "hope",
        # Negative complex
        "contempt": "disgust", "revulsion": "disgust", "loathing": "disgust",
        "shame": "despair", "guilt": "despair", "humiliation": "despair",
        "envy": "jealousy", "suspicion": "mystery", "paranoia": "anxiety",
        ...
        "playful": "amusement", "humorous": "amusement", "witty": "amusement",
        "comic": "comedic_energy", "sarcasm": "amusement", "satire": "comedic_energy",
    ...
    def retrieve_palette(self, emotion: str) -> Dict:
        ...
        # Direct match in DEFAULT_PALETTES
        if emotion_key in self.DEFAULT_PALETTES:
            return self.DEFAULT_PALETTES[emotion_key]
        
        # Synonym/semantic match
        canonical = self.EMOTION_SYNONYMS.get(emotion_key)
        if canonical and canonical in self.DEFAULT_PALETTES:
            logger.info(f"Phase 4: Mapped emotion '{emotion}' → '{canonical}' via synonym")
            return self.DEFAULT_PALETTES[canonical]

        # Tier 1: Try OpenAI for dynamic palette generation
        try:
            result = openai_json(
                prompt=(
